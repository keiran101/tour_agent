...
class Settings:
    ...
    def __init__(self):
        ...
        self.PROJECT_NAME = os.getenv("PROJECT_NAME", "Tour Agent")
        ...
        self.DEFAULT_LLM_MODEL = os.getenv("DEFAULT_LLM_MODEL", "MiMo-V2.5")
        ...
        self.AGENT_MAX_STEPS = int(os.getenv("AGENT_MAX_STEPS", "15"))
        ...
        self.MEMORY_COLLECTION_NAME = os.getenv("MEMORY_COLLECTION_NAME", "longterm_memory")

        # External API Keys (tour-specific tools)
        ...
        self.POSTGRES_DB = os.getenv("POSTGRES_DB", "tour_agent_db")
